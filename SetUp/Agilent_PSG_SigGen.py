...
class Agilent_SigGen_PSG():
    ...
    def getPower(self):
        return self.SigGen.query("POW:OUT:LEV?")
    ...
    def AmpUp(self):
        self.SigGen.write(":OUTP:LEV UP")

    def AmpDown(self):
        self.SigGen.write(":OUTP:LEV DOWN")
...
class Agilent_SigGen:
    pass


if __name__ == "__main__":
    SigGenObj = Agilent_SigGen(GPIB_Address=11)
    ampOfset = 0
